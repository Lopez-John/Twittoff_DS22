...
def predict_user(user0_name, user1_name, hypo_tweet_text):
    ...
    # vertically stak embeddings to create one list of vects
    vects = np.vstack([user0_vects, user1_vects]) # user-_vects on user1_vects
    ...
    # reassigning passed in variable in vectorized version
